...
SRC_URI="https://github.com/mltframework/shotcut/releases/download/v${PV}/${PN}-src-170601.tar.bz2 -> ${P}.tar.bz2
	https://github.com/mltframework/shotcut/releases/download/v${PV}/${PN}-linux-x86_64-170601.tar.bz2 -> shotcut-translations.tar.bz2"
