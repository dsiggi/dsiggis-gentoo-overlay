...
QA_PREBUILT="
	/opt/HeroicGamesLauncher/resources/app.asar.unpacked/build/bin/linux/gogdl
	/opt/HeroicGamesLauncher/resources/app.asar.unpacked/build/bin/linux/legendary
	"
